...
async function POST(req) {
    try {
        ...
        if (isNaN(numericPrice) || isNaN(numericStock)) {
            return new Response('Invalid price or stock value', {
                status: 400
            });
        }
        const product = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
            name,
            price: numericPrice,
            stock: numericStock,
            description,
        ...
        return new Response('Error creating product: ' + error.message, {
            status: 400
        });
    }
}
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7640c405._.js.map