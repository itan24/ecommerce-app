...
async function POST(req) {
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findOne({
            email
        });
        if (!user) {
            return new Response(JSON.stringify({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7d26b86f._.js.map